		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo Rotas",
									"targetURL": "#brcomsinosbytezui5mainapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomsinosbytezui5mainapp-display": {
								"semanticObject": "brcomsinosbytezui5mainapp",
								"action": "display",
								"description": "Demonstração Aplicativo de Rotas",
								"title": "Demo Rotas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.sinosbyte.zui5.mainapp",
									"url": sap.ui.require.toUrl("br/com/sinosbyte/zui5/mainapp")
								}
							}
						}
					}
