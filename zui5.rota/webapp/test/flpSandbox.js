		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Rota",
									"targetURL": "#brcomsinosbytezui5rota-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomsinosbytezui5rota-display": {
								"semanticObject": "brcomsinosbytezui5rota",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.sinosbyte.zui5.rota",
									"url": sap.ui.require.toUrl("br/com/sinosbyte/zui5/rota")
								}
							}
						}
					}
